<div class="template-customer">
          ...
          <?php if(isset($_GET["notify"]) && $_GET["notify"]=="success"): ?>
            <span style="color:red;">Đăng ký thành công</span>
          <?php else: ?>
            Nếu bạn chưa có tài khoản, hãy đăng ký ngay để nhận thông tin ưu đãi cùng những ưu đãi từ cửa hàng.</ p >
          <?php endif; ?>
          <div class="row" style="margin-top:50px;">
            ...
            <div class="col-md-6">
              <div class="wrapper-form">
                ...
                <a href="/Account/Login" class="button">Đăng nhập</a> </div>
            </div>
          </div>
        </div>